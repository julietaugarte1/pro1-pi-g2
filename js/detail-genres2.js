...
if(type=="movies"){
    fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&sort_by=popularity.desc&with_genres=${idGenero}&with_watch_monetization_types=flatrate`)
    ...
    fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${apiKey}&sort_by=popularity.desc&with_genres=${idGenero}&with_watch_monetization_types=flatrate&with_status=0&with_type=0`)
    .then(function (response) {
        return response.json()
    })
    .then(function (data) {
